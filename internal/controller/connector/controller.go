...
// Package connector implements the Kubernetes reconciler for Connector custom resources.
package connector
...
func (r *Reconciler) fetchConnector(ctx context.Context, req ctrl.Request) (*otilmv1alpha1.Connector, error) {
	logger := log.FromContext(ctx)
...
func (r *Reconciler) handleFinalizer(ctx context.Context, req ctrl.Request, conn *otilmv1alpha1.Connector) (bool, error) {
	logger := log.FromContext(ctx)
...
func (r *Reconciler) computeChecksums(ctx context.Context, req ctrl.Request, conn *otilmv1alpha1.Connector) (string, *ctrl.Result, error) {
...
func (r *Reconciler) reconcileServiceAccount(ctx context.Context, conn *otilmv1alpha1.Connector) error {
	logger := log.FromContext(ctx)
	desiredSA := connbuilder.BuildServiceAccount(conn)
...
func (r *Reconciler) reconcileDeployment(ctx context.Context, conn *otilmv1alpha1.Connector, combinedChecksum string) error {
	logger := log.FromContext(ctx)
	desiredDeploy := connbuilder.BuildDeployment(conn, combinedChecksum)
...
func (r *Reconciler) reconcileService(ctx context.Context, conn *otilmv1alpha1.Connector) error {
	logger := log.FromContext(ctx)
	desiredSvc := connbuilder.BuildService(conn)
...
func (r *Reconciler) reconcilePDB(ctx context.Context, conn *otilmv1alpha1.Connector) error {
	logger := log.FromContext(ctx)
	desiredPDB := connbuilder.BuildPDB(conn)
	if desiredPDB != nil {
	...
	pdbKey := types.NamespacedName{Name: connbuilder.ChildResourceName(conn), Namespace: conn.Namespace}
...
func (r *Reconciler) reconcileServiceMonitor(ctx context.Context, conn *otilmv1alpha1.Connector) error {
	logger := log.FromContext(ctx)
	desiredSM := connbuilder.BuildServiceMonitor(conn)
	if desiredSM != nil {
	...
	smKey := types.NamespacedName{Name: connbuilder.ChildResourceName(conn), Namespace: conn.Namespace}
...
func (r *Reconciler) updateDeploymentStatus(ctx context.Context, req ctrl.Request, conn *otilmv1alpha1.Connector) (*appsv1.Deployment, error) {
	logger := log.FromContext(ctx)
	var currentDeploy appsv1.Deployment
	if err := r.Get(ctx, types.NamespacedName{Name: connbuilder.ChildResourceName(conn), Namespace: conn.Namespace}, &currentDeploy); err != nil {
...
func (r *Reconciler) setDeploymentPhase(conn *otilmv1alpha1.Connector, desiredReplicas, readyReplicas int32, deploy *appsv1.Deployment) {
	switch {
...
func (r *Reconciler) setPhaseRunning(conn *otilmv1alpha1.Connector, readyReplicas, desiredReplicas int32) {
...
func (r *Reconciler) setPhaseForZeroReady(conn *otilmv1alpha1.Connector, desiredReplicas int32, deploy *appsv1.Deployment) {
	failed := false
...
func (r *Reconciler) emitPhaseTransitionEvents(conn *otilmv1alpha1.Connector, previousPhase otilmv1alpha1.ConnectorPhase) {
...
func (r *Reconciler) computeRefChecksums(
	ctx context.Context,
